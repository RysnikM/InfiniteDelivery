[![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=RysnikM_InfiniteDelivery&metric=alert_status)](https://sonarcloud.io/summary/new_code?id=RysnikM_InfiniteDelivery)
